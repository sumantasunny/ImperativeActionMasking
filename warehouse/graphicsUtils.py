...
def new_shape(object, coords):
    _canvas.coords(object, *coords)
...
def circle(pos, r, outlineColor, fillColor, endpoints=None, style='pieslice', width=2):
    ...
    return _canvas.create_arc(x0, y0, x1, y1, outline=outlineColor, fill=fillColor, extent=e[1] - e[0], start=e[0],
...
def move_by(object, x, y=None, d_o_e=lambda arg: _root_window.dooneevent(arg), d_w=tkinter._tkinter.DONT_WAIT,
            lift=False):
    if y is None:
...
ghost_shape = [(0, - 0.5), (0.25, - 0.75), (0.5, - 0.5), (0.75, - 0.75), (0.75, 0.5), (0.5, 0.75), (- 0.5, 0.75),
