...
plt.plot(x,y[1], linestyle='dashed', marker='d', color='r', label="With Probabilistic Shield")
plt.plot(x,y[2], linestyle='dashed', marker='s', color='tab:orange', label="With Look-Ahead Shield")
# plt.plot(x,y[3], marker='^', color='k', label="Shield 8 Cross")
plt.title("Scores during Training for Pacman: "+sys.argv[2].split('_')[1])
